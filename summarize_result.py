...
def main():
    ...
    files = sorted(glob.glob("subset_results_*.json"))
    if not files:
        raise SystemExit("No files matched subset_results_*.json in current directory.")
    ...
    out_csv = "summary_subset_results.csv"
