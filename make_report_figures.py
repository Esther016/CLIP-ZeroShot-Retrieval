...
# ==========================================
# 输入文件
SUMMARY_CSV = "summary_subset_results.csv"
ASSIGN_CSV  = "./failure_analysis/analysis_all/annotations_clean.csv"

# Bootstrap data files
HITS_FILES = {
    "max": "subset_hits_Action_n24_max_seed42.csv",
    "mean": "subset_hits_Action_n24_mean_seed42.csv",
    "logsumexp": "subset_hits_Action_n24_logsumexp_seed42.csv",
}
